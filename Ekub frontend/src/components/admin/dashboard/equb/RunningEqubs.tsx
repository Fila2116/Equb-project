...
import { fetchRunningEqubs } from "../../../../store/features/admin/equb/equbSlice";
import Pagination from "../../../layout/Pagination";
import ConnectionErrorPage from "../../../../utils/ErrorPage";
import Loader from "../../../../utils/Loader";

const RunningEqubs: React.FC = () => {
  const dispatch = useAppDispatch();
  const { running, totalPages, isLoading, error, successMessage } =
  ...
  useEffect(() => {
    dispatch(
      fetchRunningEqubs({ page: currentPage, limit: itemsPerPage }) as any
    );
  ...
  const handleItemsPerPageChange = (newItemsPerPage: number) => {
    ...
    dispatch(
      fetchRunningEqubs({ page: currentPage, limit: newItemsPerPage }) as any
    );
  };
