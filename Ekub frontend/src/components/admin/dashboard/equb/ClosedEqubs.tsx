...
import { fetchClosedEqubs } from "../../../../store/features/admin/equb/equbSlice";
import Pagination from "../../../layout/Pagination";
import ConnectionErrorPage from "../../../../utils/ErrorPage";
import Loader from "../../../../utils/Loader";

const ClosedEqubs: React.FC = () => {
  const dispatch = useAppDispatch();
  const { closed, totalPages, isLoading, error } = useAppSelector(
    (state) => state.equbs
  );
  ...
  useEffect(() => {
    dispatch(
      fetchClosedEqubs({ page: currentPage, limit: itemsPerPage }) as any
    );
  ...
  const handleItemsPerPageChange = (newItemsPerPage: number) => {
    ...
    dispatch(
      fetchClosedEqubs({ page: currentPage, limit: newItemsPerPage }) as any
    );
  };
  if (error) {
