...
const Sidebar: React.FC = () => {
  ...
  const brandingConfig = useAppSelector((state) => state.branding.brandingConfig);
      ...
      <div className="mt-2">
        <NavLink to="/dashboard/home">
          <img
            ...
            src={
              brandingConfig?.logoLightUrl
                ? `${import.meta.env.VITE_BACKEND_URL}/images/branding/${brandingConfig.logoLightUrl}`
                : defaultLogo
            }
            alt="logo"
            width={120}
